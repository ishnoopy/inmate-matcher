...
| `AUTH_SECRET`                     | ✅       | NextAuth.js session encryption key (generate with `openssl rand -hex 32`)              |
...
| `ENCRYPTION_KEY`                  | ✅       | Required if using email notifications (generate with `openssl rand -hex 32`)           |
